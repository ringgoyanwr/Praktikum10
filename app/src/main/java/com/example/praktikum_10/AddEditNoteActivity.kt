...
class AddEditNoteActivity : AppCompatActivity() {
    companion object {
        ...
        const val EXTRA_JUDUL1 = "com.piusanggoro.notesapp.EXTRA_JUDUL1"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra(EXTRA_ID)) {
            ...
            edit_text_description2.setText(intent.getStringExtra(EXTRA_JUDUL1))
    ...
    private fun saveNote() {
        ...
        val data = Intent().apply {
            ...
            putExtra(EXTRA_JUDUL1, edit_text_description2.text.toString())
